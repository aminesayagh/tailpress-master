...
function wpc_elementor_shortcode_test_query(){
	get_template_part('template-parts/test_query_favorite', 'test_query_favorite');
}

add_shortcode('test_query_favorite', 'wpc_elementor_shortcode_test_query');
