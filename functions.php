...
function wpc_elementor_shortcode_content_scan(){
	get_template_part('template-parts/content_scan', 'content_scan');
}

add_shortcode('content_scan', 'wpc_elementor_shortcode_content_scan');
